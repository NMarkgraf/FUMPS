...
1. $\displaystyle 4x^2+12x+9=$\setlength{\itemsep}{12pt}

2. $\displaystyle 9x^2+12xy+4y^2=$

3. $\displaystyle 16x^2-72xy+81y^2$

4. $\displaystyle x^2+ xy +y^2$


### Übungsaufgaben

1. $(x-y)^2-(x+y)^2 + 4xy =$\setlength{\itemsep}{12pt}
